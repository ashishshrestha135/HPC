...
int main() {
  ...
  MPI_Recv(&data[3],3, MPI_UNSIGNED_CHAR,1,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[6],3, MPI_UNSIGNED_CHAR,2,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[9],3, MPI_UNSIGNED_CHAR,3,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[12],3, MPI_UNSIGNED_CHAR,4,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[15],3, MPI_UNSIGNED_CHAR,5,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[18],3, MPI_UNSIGNED_CHAR,6,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  MPI_Recv(&data[21],3, MPI_UNSIGNED_CHAR,7,0,MPI_COMM_WORLD,MPI_STATUS_IGNORE);
  ...
  data[final_i + 2],data[final_i]);
  
  
}
 }else{
      double data[] = {be, bm, bc};
